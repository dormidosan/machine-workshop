...
import { aboutCarouselImages } from "@/app/resources/about-images";
    ...
    <div className="space-y-6">
              ...
              <div className="flex-[0_0_33.33%] min-w-0 pl-1" key={index}>
                <div className="p-1 aspect-[4/3] relative">
                  <Image
                    ...
                    alt={`Molde personalizado ${index + 1}`}
                    fill
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="border-[#e5e5e5] py-4">
          ...
          <CardContent>
            <p>
              Metalyplast es una empresa dedicada a la fabricación y mantenimiento de moldes de inyección y
