      ...
      {isOpen ? (
        ...
        <div className="flex flex-col gap-2 mb-4">
          <DefaultButton
            ...
            style={{ display: "none" }} // Hide the button until AI is implemented
          >
          ...
          >
            <BasicButton
              size="icon"
              className="h-14 w-14 rounded-full shadow-lg bg-green-400 hover:bg-green-600  text-primary-foreground inline-flex items-center justify-center transition-all"
            >
